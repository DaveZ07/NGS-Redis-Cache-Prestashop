...
class NgsRedisCachingTypeForm extends CachingType
{
        ...
        $builder
            ...
            ->add('caching_system', ChoiceType::class, [
                ...
                'choice_label' => function ($value, $key, $index) {
                    $disabled = false;
                    if (isset($this->extensionsList[$index])) {
                ...
                'help' => '<a href="' . \Context::getContext()->link->getAdminLink('AdminNgsRedisConfiguration') . '" class="btn btn-default" style="margin-top:10px"><i class="icon-cogs"></i> ' . $this->trans('Configure NGS Redis', 'Modules.Ngsredis.Admin') . '</a>',
                'help_html' => true,
            ]);
    }
    ...
    public static function modifyForm(FormBuilderInterface $builder) {
